# Chave estrangeira: Um campo em uma tabela de banco de dados relacional que cria um vínculo entre duas tabelas, garantindo a integridade referencial dos dados.

# Escalabilidade horizontal: A capacidade de um sistema de aumentar seu desempenho distribuindo a carga de trabalho entre múltiplos servidores ou bancos de dados.

# Escalabilidade vertical: A prática de aumentar os recursos de hardware de um único servidor ou banco de dados para melhorar o desempenho.

# JSON: Um formato de intercâmbio de dados leve e fácil de ler, usado para representar objetos e estruturas de dados complexas em bancos de dados NoSQL.

# NoSQL: Um tipo de banco de dados que oferece flexibilidade na estruturação dos dados, ideal para aplicações que não requerem uma estrutura rígida.

# PostgreSQL: Um sistema de gerenciamento de banco de dados relacional avançado que suporta extensões e é conhecido por sua conformidade com padrões SQL.

# SQL: Uma linguagem padrão para gerenciamento de bancos de dados relacionais, usada para manipular e consultar dados organizados em tabelas.

# Tabela: A estrutura básica de armazenamento de dados em um banco de dados relacional, composta por linhas e colunas.
