# Dada um arrayz números inteiros, cada elemento aparece duas vezes, exceto um, Encontre ele.

meu_arrayzinho = [1,1,2,2,3,3,4,5,5,6,6]


# 1. Criar um dicionário para adicionar os valores do array através da chave - valor
