# Você recebe um array indexada em 0 de palavras de strings e um caractere x.
# Retorne um array de índices representam as palavras que contêm o caractere x.
